          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            <div>
              <input
                ...
                className="w-full bg-cinema-bg border border-cinema-border rounded-lg px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-teal-500/50 transition-colors"
              />
            </div>
            <div>
              <input
            ...
            <div>
              <textarea
                ...
                className="w-full bg-cinema-bg border border-cinema-border rounded-lg px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-teal-500/50 transition-colors resize-none"
              />
            </div>
            <button
              type="submit"
              className="w-full bg-teal-gradient text-black font-bold py-3 rounded-lg hover:opacity-90 transition-opacity text-sm"
            >
              Send Message
            </button>
          </form>

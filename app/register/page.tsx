        ...
        <div className="card-cinema p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-xs text-slate-500">
              ...
              <span className="text-teal-400 cursor-pointer hover:text-teal-300">Terms of Service</span> and{" "}
              <span className="text-teal-400 cursor-pointer hover:text-teal-300">Privacy Policy</span>.
            </p>
